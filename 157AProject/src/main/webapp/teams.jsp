...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto py-8">
        <!-- Header -->
        <h1 class="text-3xl font-bold text-center mb-8">Teams Management</h1>
        ...
        <div class="flex justify-center space-x-4 mb-8">
            ...
            <button class="bg-red-500 text-white px-6 py-2 rounded-md hover:bg-red-600" onclick="scrollToRemoveForm()">Remove Team</button>
        </div>
        ...
        <!-- Delete A Team Form -->
        <div class="bg-white shadow-md rounded-lg p-6 mt-6" id="deleteForm">
